...
% Sorting and displaying image
[sortedHeaders, sortIdx] = sort(allHeaders, 'ascend');
messagesSorted = [];
for i = 1:length(sortIdx)
    messagesSorted = [messagesSorted, allMessages(:, sortIdx(i))];
end

decompressedImage = reconstructImage(messagesSorted);
