...
% %%% ---------------------------------------------------
% %%% Fredrikstad resampled 24000 Hz:
% %%% ---------------------------------------------------
% % Read voice message
% 
% % If you want symbols (0, 3)
...
%%% ---------------------------------------------------
%%% Fredrikstad resampled 11000 Hz:
%%% ---------------------------------------------------
% Read voice message

% If you want symbols (0, 3)
% [voiceMessage, fs] = setupVoiceFromFile("VoiceFiles/fredrikstad_11000.wav");

load("voiceFiles/fredrikstad_11000.mat");
voiceMessage = s.voiceMessage;
fs = s.fs;
...
partitions = 58;
voiceMessageCut = voiceMessage(1:174000);
